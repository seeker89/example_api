 ...
 * @return Customer
 */
//func (a AccountApi) CreateAccount (body CreateAccountRequest) (Customer, error) {
func (a AccountApi) CreateAccount (body CreateAccountRequest) (Customer, error) {
 ...
 * @return Transaction
 */
//func (a AccountApi) CreateTransfer (body CreateTransferRequest) (Transaction, error) {
func (a AccountApi) CreateTransfer (body CreateTransferRequest) (Transaction, error) {
 ...
 * @return Account
 */
//func (a AccountApi) GetAccount (accountId string) (Account, error) {
func (a AccountApi) GetAccount (accountId string) (Account, error) {
 ...
 */
//func (a AccountApi) GetAccountHistory (accountId string) (TransactionArray, error) {
func (a AccountApi) GetAccountHistory (accountId string) (TransactionArray, error) {
  ...
  var successPayload = new(TransactionArray)
